                    ...
                    <div class="col s12">
                      <table class="responsive-table highlight centered">
                        ...
                        <tbody>
                          ...
                          $sql = mysqli_query($conn, "SELECT * FROM cuti WHERE stt_cuti!='proses' $cari_nik $cari_nm_karyawan $cari_tgl_mulai $cari_tgl_selesai AND id_dept='$_SESSION[departemen]'");
