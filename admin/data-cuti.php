          ...
          <div id="responsive-table">
            <div class="row">
              <div class="col s12 mt-3">
                <!-- Modal Trigger -->
                <a class="waves-effect waves-light btn blue inline-flex" href="<?= $df['host'] . 'admin/form-cuti.php'; ?>">Tambah
                ...
                <table class="responsive-table highlight centered">
                  <thead>
                    <tr>
                      ...
                      <th data-field="nama-cuti">Nama Cuti</th>
                      <th data-field="jumlah-cuti">Jumlah Cuti</th>
                  ...
                  <tbody>
                    ...
                    for ($i = 1; $Data = mysqli_fetch_array($sql); $i++) { ?>
                      <tr>
                        ...
                        <td><?= $Data['jml_jc']; ?></td>
                        <td>
                          <a href="<?= $df['host'] . 'admin/form-cuti.php?idjc=' . $Data['id_jc']; ?>" class="waves-effect waves-light btn green lighten-1">Edit</a>
                          <a href="<?= $df['host'] . 'admin/form-cuti.php?didjc=' . $Data['id_jc']; ?>" class="waves-effect waves-light btn amber darken-1">Hapus</a>
                        </td>
                      </tr>
                    <?php } ?>
                  </tbody>
